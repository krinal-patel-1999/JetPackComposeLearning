package com.tweetesAppWithMVVMAndFlow.repository
...
class TweetRepository @Inject constructor(private  val tweetsyApi: TweetsyApi){
    ...
    private val _tweets = MutableStateFlow<List<TweetList.Tweet>>(emptyList())
    val tweet:StateFlow<List<TweetList.Tweet>>
        get() = _tweets
